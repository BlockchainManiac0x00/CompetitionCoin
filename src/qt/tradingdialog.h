...
private slots:
    ...
    QString BuyCMPC(QString OrderType, double Quantity, double Rate);
    QString SellCMPC(QString OrderType, double Quantity, double Rate);
